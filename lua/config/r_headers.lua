...
vim.keymap.set("n", "<leader>r1", function() insert_header(1) end, { desc = "Header: # title ----" })
vim.keymap.set("n", "<leader>r2", function() insert_header(2) end, { desc = "Header: ## title ----" })
vim.keymap.set("n", "<leader>r3", function() insert_header(3) end, { desc = "Header: ### title ----" })
vim.keymap.set("n", "<leader>r4", function() insert_header(4) end, { desc = "Header: #### title ----" })
vim.keymap.set("n", "<leader>r-", function() insert_underline('-') end, { desc = "Header: underline -" })
vim.keymap.set("n", "<leader>r=", function() insert_underline('=') end, { desc = "Header: underline =" })
vim.keymap.set("n", "<leader>rB", function() insert_box('thin') end, { desc = "Header: boxed (thin)" })
vim.keymap.set("n", "<leader>rH", function() insert_box('heavy') end, { desc = "Header: boxed (heavy)" })
vim.keymap.set("n", "<leader>rT", insert_template, { desc = "Header: template Title/Author/Date" })
...
end, { desc = "Header from selection: # ----" })
...
vim.keymap.set("v", "<leader>r4", function()
  replace_visual_with_header(function(text) return build_hash_header(text, 4) end)
end, { desc = "Header from selection: #### ----" })
vim.keymap.set("v", "<leader>r-", function()
  replace_visual_with_header(function(text) return build_underline_header(text, '-') end)
end, { desc = "Header from selection: underline -" })
vim.keymap.set("v", "<leader>r=", function()
  replace_visual_with_header(function(text) return build_underline_header(text, '=') end)
end, { desc = "Header from selection: underline =" })
vim.keymap.set("v", "<leader>rB", function()
  replace_visual_with_box('thin')
end, { desc = "Header from selection: boxed (thin)" })
vim.keymap.set("v", "<leader>rH", function()
  replace_visual_with_box('heavy')
end, { desc = "Header from selection: boxed (heavy)" })
